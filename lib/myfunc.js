...
export const serialize = (conn, msg) => {
    ...
    try {
        ...
        msg.quotedMsg.chats = (ane.type === 'conversation' && ane.conversation) ? ane.conversation : 
        ...
        msg.quotedMsg.key.device = bail.getDevice(msg.message[msg.type].contextInfo.stanzaId);
    } catch {
        msg.quotedMsg = null;
